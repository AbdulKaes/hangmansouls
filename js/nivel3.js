...
function generarPalabra() {
    ...
    var palabras = ["Duende", "Blanco", "Verde", "Caida", "Tronco", "Arco", "Flecha", "Tranquilidad"];
...
function mostrarPistaDePalabra() {
    ...
    if (palabraAdivinar === "DUENDE" || palabraAdivinar === "BLANCO" || palabraAdivinar === "ARCO" || palabraAdivinar === "FLECHA")
        pistaTextArea.value = "Acaso la palabra tendra que ver con el enemigo?";
    else if (palabraAdivinar === "CAIDA" || palabraAdivinar === "TRONCO" || palabraAdivinar === "VERDE")
        pistaTextArea.value = "La zona... si lo piensas puede que tenga que ver con la palabra";
    else if (palabraAdivinar === "TRANQUILIDAD")
        pistaTextArea.value = "Escuchas ese canto? El sentimiento que genera...";
}

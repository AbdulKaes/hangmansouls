...
function generarPalabra() {
    ...
    var palabras = ["Hueso", "Bosco", "Mal", "Hoja", "Rama", "Facil", "Azul", "Larry"];
...
function mostrarPistaDePalabra() {
    ...
    if (palabraAdivinar === "HUESO" || palabraAdivinar === "AZUL" || palabraAdivinar === "LARRY")
        pistaTextArea.value = "Esta palabra es facil. Tan solo fijate contra lo que te enfrentas.";
    else if (palabraAdivinar === "BOSCO" || palabraAdivinar === "HOJA" || palabraAdivinar === "RAMA")
        pistaTextArea.value = "Esta palabra es facil. Fijate en donde te enfrentas.";
    else if (palabraAdivinar === "FACIL")
        pistaTextArea.value = "Esta palabra es facil. El nivel y la pista lo dicen.";
    else if (palabraAdivinar === "MAL")
        pistaTextArea.value = "Esta palabra es facil. De los errores se aprende.";
}
